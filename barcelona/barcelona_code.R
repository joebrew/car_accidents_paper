...
##### Data read in
csvs <- dir('barcelona/car_accidents/')
csvs <- csvs[grepl('.csv', csvs)]
csvs <- paste0('barcelona/car_accidents/', '/', csvs)
...
##### Geographic data
mapa <- readOGR( 'geo/barris', 'BCN_Barri_SHP')
...
football <- read_csv(paste0('barcelona', '/football_games/games_2010-2014.csv'))
